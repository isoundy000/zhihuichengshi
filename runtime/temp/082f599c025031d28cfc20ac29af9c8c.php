<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"D:\wwwroot\zhihuichengshi/city/staff\view\index\index.html";i:1491391891;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="main-container-inner">
                ...
                <div class="sidebar" id="sidebar">
                    ...
                    <div class="sidebar-shortcuts" id="sidebar-shortcuts">
                        <div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">房源管理</div>
                    ...
                    <ul class="nav nav-list" id="nav_list">
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                <li class="home">
                                    <a href="javascript:void(0)" name="<?php echo url('House/add'); ?>" title="添加房源" class="iframeurl">
                                        <i class="icon-double-angle-right"></i>添加房源</a>
                                </li>
                                <li class="home">
                                    <a href="javascript:void(0)" name="<?php echo url('House/index'); ?>" title="所有房源" class="iframeurl">
                                        <i class="icon-double-angle-right"></i>所有房源</a>
                                </li>
                                <li class="home">
                                    <a href="javascript:void(0)" name="<?php echo url('House/index?zt=0'); ?>" title="未租房源" class="iframeurl">
                                        <i class="icon-double-angle-right"></i>未租房源</a>
                                </li>
                                <li class="home">
                                    <a href="javascript:void(0)" name="<?php echo url('House/index?zt=1'); ?>" title="已租房源" class="iframeurl">
